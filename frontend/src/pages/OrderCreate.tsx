...
const OrderCreate = () => {
  ...
  return (
    <ProfileGuard message="Чтобы опубликовать заказ, пожалуйста, заполните информацию о себе в профиле (имя, описание и навыки). Это поможет исполнителям лучше понять ваши требования.">
